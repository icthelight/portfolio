    ...
    return (
        <Container>
            <Desc>
              ...
              <p>반응형 사이트를 제작할 때 부모 컨테이너의 너비가 변화하면 그 안에 담긴 자식 이미지의 너비와 높이가 그에 비례하여 줄어들거나 늘어나도록
              padding 속성을 이용할 수 있다. 이를 활용하여 재사용 가능한 RatioBox 컴포넌트를 제작해보았다.
              </p>
              <Image src={box1}/>
              <p>
                위와 같이 box 컨테이너를 전체 화면이라고 볼 때 item의 높이는 부모의 높이에 따라 결정되기 때문에 화면의 너비가 줄어든다고 해도
                높이가 알맞게 조절되지 않는다.
              </p>
              <p>
              ...
              <p>
                item 안에 이미지를 넣으려면 어떻게 해야 할까? <br/>
              ...
              <p>
                ...
                padding-top 의 값을 height / width * 100 으로 설정해주면 재사용할 때마다 다른 값으로 설정하기 때문에 편리하다.
              </p>
              <Image src={box5}/>
              <p>
