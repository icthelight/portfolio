    ...
    <Container>
      <Desc>
        ...
        <Link href={'https://www.npmjs.com/package/qs'}>
          <a target={'_blank'}> npm qs 공식 페이지 가기</a>
        </Link>
        <p>
          간단하게 살펴보자면 <br/>
        ...
        <p>qs를 사용해보자!</p>
        <Image src={qs3}/>
        <p>콘솔 창을 확인해보면 이전처럼 split이나 객체로 만드는 등의 과정 없이 한 번에 간편하게 location.search 의 값이 객체 형태로 담겨있다!</p>
        <Image src={qs4}/>
        <p></p>
        <Image src={qs5}/>
        ...
        <p>
          ...
          문자로 변경하여 더해준다. (이때 문자로 변경하는 이유는 url 주소는 문자 형태로 기재해야 하기 때문임)
        </p>
        <Image src={qs6}/>
